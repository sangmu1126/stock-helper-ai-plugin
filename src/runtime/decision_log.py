...
def create_decision_log(
    *,
    ...
    return DecisionLog(
        ...
        parser_version=str(parser.get("source", "runtime")),
        ...
        idempotency_key=str(decision_result.get("idempotency_key") or stable_id(rule_id, trigger_evaluation)),
        created_at=datetime.now(timezone.utc).isoformat(),
        metadata={"policy_decision": policy_result.get("decision")},
    )
